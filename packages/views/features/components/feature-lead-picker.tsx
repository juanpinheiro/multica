...
export function FeatureLeadPicker({ feature, handleUpdate, renderTrigger, align = "start" }: {
  feature: Feature;
  handleUpdate: (data: UpdateFeatureRequest) => void;
  ...
  const leadId = feature.lead_id;
  const leadType = feature.lead_type;
