...
func NewRouterWithOptions(pool *pgxpool.Pool, hub *realtime.Hub, bus *events.Bus, opts RouterOptions) (chi.Router, *handler.Handler) {
	...
	r.Route("/api/daemon", func(r chi.Router) {
		...
		r.Post("/tasks/{taskId}/wait-local-directory", h.WaitTaskForLocalDirectory)
	...
	r.Group(func(r chi.Router) {
		...
		r.Group(func(r chi.Router) {
			...
			// Decisions — workspace-wide Decision Log across every Initiative.
			r.Get("/api/decisions", h.ListDecisionLogWorkspace)
